...
function gamipress_maybe_award_points( $user_id = 0, $achievement_id = 0 ) {
	...
	if ( isset( $points_types[$points_type] ) ) {
        ...
        /**
         * Filter available to override the amount of points to award or deduct
         *
         * @since  6.9.8
         *
         ...
         * @return int
         */
        $points = apply_filters( 'gamipress_maybe_award_points_amount', $points, $points_type, $user_id, $achievement_id );
