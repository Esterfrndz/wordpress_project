...
function gamipress_insert_user_earning( $user_id = 0, $data = array(), $meta = array() ) {
    ...
    /**
     * Filter available to override the user earning data
     *
     * @since  6.9.8
     *
     * @param  array    $data               User earning data
     ...
     * @return array
     */
    $data = apply_filters( 'gamipress_insert_user_earning_data', $data, $meta, $user_id );

    /**
     * Filter available to override the user earning metadata
     *
     * @since  6.9.8
     *
     * @param  array    $meta               User earning meta data
     ...
     * @return array
     */
    $meta = apply_filters( 'gamipress_insert_user_earning_meta', $meta, $data, $user_id );
