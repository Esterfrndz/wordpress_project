...
class Validation
{
    ...
    static function validateReward($post)
    {
        ...
        $labels_array = array(
            ...
            'max_discount' => __('Maximum discount', 'wp-loyalty-rules'),
        );
        $labels_array_fields = array(
        ...
        $rule_validator->rule('in', ['coupon_type'], ['percent', 'fixed_cart'])->message(__('{field} is invalid', 'wp-loyalty-rules'));
        ...
        if ($post['coupon_type'] == 'percent') {
            $required_fields = array_merge($required_fields, array('max_discount', 'max_percentage'));
        }
        ...
        if (isset($post['coupon_type']) && $post['coupon_type'] == 'percent') {
            $rule_validator->rule('isEmpty', array('max_discount', 'max_percentage'))->message(__('{field} is empty', 'wp-loyalty-rules'));
