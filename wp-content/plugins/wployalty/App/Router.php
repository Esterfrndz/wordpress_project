...
class Router
{
    ...
    function init()
    {
        ...
        if (is_admin()) {
            ...
            /*End MyAccount*/
            add_shortcode('wlr_thank_you_message', array(self::$display_message, 'shortCodeForThankYouPageMessage'));
        }
        ...
        add_filter('woocommerce_coupon_get_discount_amount', array(self::$site, 'getPointConversionDiscountAmount'), 10, 5);
