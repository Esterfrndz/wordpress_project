        ...
        $json = array(
            ...
            'common' => array(
                ...
                'select' => array(
                    ...
                    'percentage_fixed_options' => array(
                        array(
                            'value' => 'fixed_cart',
...
//                'update' => __('Update', 'wp-loyalty-rules'),
                ...
                "empty_revenue_value" => sprintf(__('%s', 'wp-loyalty-rules'), wc_price(0, array('currency' => $current_currency))),
                'empty' => array(
...
//                    'name' => __('Points to collect', 'wp-loyalty-rules'),
            ...
            'settings' => array(
                ...
                'earn_point' => array(
                    ...
                    'allow_earning_when_coupon' => array(
